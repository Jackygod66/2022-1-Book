...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MyAdapter(Context context, List<Shop> mBeanList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //if(viewType == TYPE_LINEAR_LAYOUT){
            View view = mLayoutInflater.inflate(R.layout.activity_show_all, parent, false);
        ...
        holder.rlContainer.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                tvDelete.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        int row = mNoteDbOpenHelper.deleteFromDbById(shop.getId());
                        if (row > 0) {
                            removeData(position);
                        }
                        dialog.dismiss();
...
*/
    ...
    public void refreshData(List<Shop> shops) {
        this.mBeanList = shops;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            this.rlContainer = itemView.findViewById(R.id.ll_item_container);
        }
    }
/*
