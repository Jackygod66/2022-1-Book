...
public class item_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.query(TABLENAME,null,"id=?",new String[]{id},null,null,null,null); // 根据接收到的id进行数据库查询
        ...
        Cursor cursor1 = db.query("comments",null,"itemId=?",new String[]{id},null,null,null,null); // 数据库查询
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!submit_comment.equals(null)&&!submit_comment.equals("")){
                    ...
                    Intent intent=new Intent(item_info.this, HomeFragment.class);
                    startActivity(intent);
                }
                else Toast.makeText(getApplicationContext(), "评论不能为空", Toast.LENGTH_SHORT).show();
            }
        });
        Button add_in_cart = findViewById(R.id.add_in_cart);
        add_in_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("商品的id是",intent.getStringExtra("id"));
                Log.i("2","添加成功");
                //Intent intent=new Intent(item_info.this, item_info.class);
